...
// Modified by Nathan Bowman 2019
...
public class NumberBaseTest_Sample {
   ...
   /*
   // These tests check whether your program is able to handle invalid inputs.
   // I will not be testing your program with invalid inputs, so the tests are
   // commented out. If you wish to make your program more robust, you can use
